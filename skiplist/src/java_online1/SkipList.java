...
import java_online1.SkipList.Entry;

public class SkipList<T extends Comparable<? super T>> {
        static final int POSSIBLE_LEVELS = 95;
        ...
        public T closetKeyAfter(T x) {
            ...
            if (!contains(x)) 
                   ...
                   System.out.println( last[0].next[0].element);
        ...
        private void find(T x) {
            ...
            for (i = 0; i < maxLevel; i++) {
                     in = maxLevel - 1 - i; // starting from top
                    ...
                    //System.out.println("the element: "+x+" is at level: "+in);
        ...
        public void findelement(T x) 
        {
        	if(contains(x)==true) {
        		find(x);
        		System.out.println("element "+x+" found at level: "+ i);
       ...
       public void printListSpan() {
        ...
        public static void main(String[] args) {
        	System.out.println("enter the number range to be inserted in the SkipList: ");
        	Scanner input=new Scanner(System.in);
        	int userIP=input.nextInt();
        	{
                SkipList<Integer> sk = new SkipList<> ();
                for (int i = 1; i <userIP; i++) sk.insert(i);
                ...
                do
                {
                System.out.println("enter one of the following operations (1.Insert 2.delete "
                		+  " 3.find 4.closetkeyafter 5.size) ");
                int choice = input.nextInt();            
                switch (choice)
                {
                case 1 : 
                    System.out.println("Enter integer element to insert");
                    sk.insert( input.nextInt() );   
                    break; 
                case 2 : 
                    System.out.println("Enter integer element to remove");
                    sk.remove( input.nextInt() );   
                    break; 
                case 3 : 
                    System.out.println("Enter integer element to find");
                    sk.findelement( input.nextInt() );   
                    break; 
                case 4 : 
                    System.out.println("Enter integer element to find closetKeyAfter");
                    sk.closetKeyAfter( input.nextInt() );   
                    break; 
                case 5: 
                System.out.println("Number of keys in the dictionary="+ sk.size());
                    
                    break;       
                case 6:
                	SkipList<Integer> sk1 = new SkipList <>();
                    for (int i = 1; i < 100000; i++) sk.insert(i);
        ...
        while (ch == 'Y'|| ch == 'y');               
               ...
               // int a=in.nextInt();
               // System.out.println(sk.contains(a)); 
